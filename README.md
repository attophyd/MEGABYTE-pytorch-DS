...
## MEGABYTE - Pytorch - DeepSpeed Setup

Modificated DeepSpeed training setup fork of <a href="https://github.com/lucidrains/MEGABYTE-pytorch">MEGABYTE - PyTorch</a> by lucidrains, Predicting Million-byte Sequences with Multiscale Transformers, in Pytorch. Took the liberty to generalize it even further so one can have multiple local models.
